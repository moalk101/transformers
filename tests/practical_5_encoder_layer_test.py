...
STATE_DICT = {
    ...
    'feature_transformation.ff.0.weight': torch.tensor([[-0.6284, -0.6438,  1.5350,  1.1490],
    ...
    'feature_transformation.ff.0.bias': torch.tensor([-0.6578,  0.0737, -1.1023,  1.0154, -0.0636,  0.6766]),
    'feature_transformation.ff.2.weight': torch.tensor([[-0.1321, -0.8338,  1.9037,  1.3632, -0.5201, -0.1429],
    ...
    'feature_transformation.ff.2.bias': torch.tensor([0.2078,  0.2490,  0.0818, -0.0595]),
